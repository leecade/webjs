...
function Request (req) {
    ...
    Object.deineProperty(this, 'connecttion', { get: function () { return req.connecttion; } }
    Object.deineProperty(this, 'self', { get: function () { return req; } }
...
var navites = ["socket","connection","httpVersion","complete","headers","trailers","readable","_paused","_pendings","_endEmitted","url","method","statusCode","client","httpVersionMajor","httpVersionMinor","upgrade","originalUrl","_parsedUrl","fn","destroy","setEncoding","pause","resume","_emitPending","_emitData","_emitEnd","_addHeaderLine","pipe","setMaxListeners","emit","addListener","on","once","removeListener","removeAllListeners","listeners"];